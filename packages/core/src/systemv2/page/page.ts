import { createOrderString } from "@ohno-editor/core/helper";
import { DictNode, LinkedDict } from "@ohno-editor/core/struct";
import {
  AnyBlock,
  Block,
  BlockData,
...
import { createRange, setLocation, setRange } from "../selection";
import {
  isParent,
  isActivate,
  markActivate,
...
export class Page implements IPage {
  ...
  constructor(init?: PageInit) {
    ...
    if (blocks) {
      ...
      this.appendBlock(this.createBlock("paragraph"));
    }
