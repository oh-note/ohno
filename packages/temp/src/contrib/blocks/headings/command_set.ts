...
export class HeadingsCommandSet implements CommandSet<Headings> {
  collapsedEnter(
    builder: ListCommandBuilder<CommonPayLoad<Headings>, InnerHTMLExtra>
  ): void {
    builder
  ...
  deleteAtBlockEnd(
    builder: ListCommandBuilder<DeletePayLoad<Headings>, EditableExtra>
  ): void {
    builder
  ...
  backspaceAtStart(
    builder: ListCommandBuilder<BackspacePayLoad<Headings>, EditableExtra>
  ): "connect" | "independent" {
  ...
  removeMultipleEditable(
    builder: ListCommandBuilder<CommonPayLoad<Headings>, Dict>
  ): void {
    return;
  }
