...
import { outerHTML } from "../functional";
import { AnyBlock } from "./imp";

export interface BlockSerializer<T extends AnyBlock> {
...
export type BlockSerializedData<T extends Dict = Dict> = {
  type: string;
  data: T;
  head?: boolean;
  tail?: boolean;
...
export abstract class BaseBlockSerializer<T extends AnyBlock>
