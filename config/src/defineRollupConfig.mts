    ...
    ({ name, path: inputPath, globalVariableName }): RollupOptions[] => {
      ...
      > = {
        esm: {
          input: inputPath,
          output: {
            file: outputOptions.esm.file ?? `./dist/ohno.${name}.esm.js`,
            format: 'esm',
          },
        ...
        mjs: {
          input: inputPath,
          output: {
            file: outputOptions.mjs.file ?? `./dist/ohno.${name}.mjs`,
            format: 'esm',
          },
        ...
        cjs: {
          ...
          output: {
            ...
            file: outputOptions.cjs.file ?? `./dist/ohno.${name}.cjs`,
        ...
        umd: [
          {
            ...
            output: {
              name: globalVariableName,
              file:
                outputOptions.umd.file ?? `./dist/ohno.${name}.umd.js`,
              format: 'umd',
          ...
          },
          {
            ...
            output: {
              name: globalVariableName,
              file: outputOptions.umd.file ?? `./dist/ohno.${name}.umd.min.js`,
              format: 'umd',
              globals: outputOptions.umd.globals,
            },
            external: outputOptions.umd.external,
        ...
        browser: [
          ...
          },
          {
            ...
            output: {
              file:
                outputOptions.browser.file ??
                `./dist/ohno.${name}.browser.min.mjs`,
              format: 'esm',
            },
            external: outputOptions.browser.external,
            plugins: [
